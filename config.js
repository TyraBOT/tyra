module.exports = {
  OWNER_IDS: ["767390456388517888"], // Bot owner ID's
  PREFIX: ">", // Default prefix for the bot
  SUPPORT_SERVER: "https://discord.gg/8HYCm3MpzR", // Your bot support server
  DASHBOARD: {
  ...
  INTERACTIONS: {
    ...
    TEST_GUILD_ID: "884489350509887588", // Guild ID where the interactions should be registered. [** Test you commands here first **]
  },
  XP_SYSTEM: {
